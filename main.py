...
def fetch_contact_data():
    ...
    contact_us_ref = db.collection('DD_email_notify')
...
def send_email(contact_data, sent_data):
    ...
    smtp_password = 'xyttkiflarkzegbi'
    
    # Create a MIMEText object
    msg = MIMEMultipart()
    msg['From'] = smtp_username
    msg['To'] = 'arraygraphs.services@gmail.com'
    msg['Subject'] = 'New Contact Request from Arraygraphs Website'
    ...
    try:
        ...
        server.sendmail(smtp_username, 'arraygraphs.services@gmail.com', msg.as_string())
        server.quit()
        print("Email sent successfully to Arraygraphs!")
...
# asiknfjoi
    ...
    msg['From'] = smtp_username
    msg['To'] = email
    msg['Subject'] = 'Thank You for Contacting Arraygraphs'
